function plotCpWing(b,simSteadyParam,yMesh_loop,analysisParams,aer_x,aer_y,aer_z,cp)
...
surf(aer_x(1:end-1,1:end),aer_y(1:end-1,1:end),aer_z(1:end-1,1:end),cp','EdgeAlpha',0.0,'FaceAlpha',0.8,'FaceColor','interp'); hold on
