...
simInput.force_input = simUnsteadyParam.morphingRoll;   % Morphing actuation input (unsymmetric -> roll)
...
simInput.rotOmega = zeros(1,simUnsteadyParam.iTest);    

% Morphing actuation (unsymmetric -> roll)
simInput.forceShape1 = sin(2*pi*(k*simUnsteadyParam.V/paramFSI.wingParams.chord*2/2/pi)*simUnsteadyParam.dT*(0:simUnsteadyParam.iTest-1)); 

% Morphing actuation (symmetric -> load alleviation)
simInput.forceShape2 = zeros(1,simUnsteadyParam.iTest); 
